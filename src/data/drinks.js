...
export const DRINKS = [
  ...
  { name: "Awesome Orange", aka: null, flavors: [F.STRAWBERRY, F.ORANGE, F.LIME], limited: true },
  ...
  { name: "Black Forest", aka: null, flavors: [F.DARK_CHOCOLATE, F.CHERRY], limited: true },
  ...
  { name: "Coral Reef", aka: null, flavors: [F.VANILLA, F.ORANGE], toppings: [T.BLUE_RAZ_FLOAT], limited: true },
  ...
  { name: "Cutie", aka: "Creamsicle", flavors: [F.WHITE_CHOCOLATE, F.ORANGE], limited: true },
  ...
  { name: "Fire Lizard", aka: null, flavors: [F.STRAWBERRY, F.ORANGE, F.BANANA], limited: true },
  { name: "Firestorm", aka: "Tricky Tre", flavors: [F.PEACH, F.ORANGE], limited: true },
  ...
  { name: "Hawaiian", aka: null, flavors: [F.PEACH, F.STRAWBERRY, F.ORANGE, F.BANANA], limited: true },
  ...
  { name: "Hyperchrome", aka: "OPP", flavors: [F.ORANGE, F.POMEGRANATE, F.PASSION_FRUIT], limited: true },
  ...
  { name: "Lowki", aka: "Kings Of Leon", flavors: [F.ORANGE, F.LIME, F.KIWI], limited: true },
  ...
  { name: "Marmalade", aka: null, flavors: [F.STRAWBERRY, F.ORANGE, F.GRAPEFRUIT], limited: true },
  ...
  { name: "Orangesicle", aka: "50/50 Bar", flavors: [F.VANILLA, F.ORANGE], limited: true },
  ...
  { name: "Popstar", aka: "Otterpop", flavors: [F.ORANGE, F.PASSION_FRUIT, F.ALMOND], limited: true },
  ...
  { name: "Rocky Point", aka: null, flavors: [F.PEACH, F.ORANGE, F.COCONUT, F.BLACKBERRY], limited: true },
  ...
  { name: "Sweet Sunrise", aka: null, flavors: [F.PEACH, F.ORANGE, F.PASSION_FRUIT, F.BANANA], limited: true },
  { name: "Sweetie Pebbles", aka: null, flavors: [F.VANILLA, F.CHERRY], limited: true },
  ...
  { name: "Trixie", aka: "Pixie Stick", flavors: [F.ORANGE, F.POMEGRANATE, F.ALMOND], limited: true },
